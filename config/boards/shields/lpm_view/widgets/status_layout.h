...
#define KEYPOINT_PROFILE_SLOT_WIDTH 30
#define KEYPOINT_PROFILE_SLOT_HEIGHT 24
#define KEYPOINT_PROFILE_CORNER_SIZE 7
#define KEYPOINT_PROFILE_MARK_SIZE 7
#define KEYPOINT_PROFILE_MARK_X_OFFSET 20
#define KEYPOINT_PROFILE_MARK_Y_OFFSET 6

#define KEYPOINT_LAYER_CHIP_X 2
#define KEYPOINT_LAYER_CHIP_Y 20
